...
**Phase 0 (Machbarkeit) abgeschlossen — Entscheidung offen.**
...
Es wurde noch kein Code geschrieben. Phase 1 startet erst nach der Entscheidung
über die Zielplattform.

## Geplanter Aufbau

| Phase | Inhalt |
|---|---|
| 1 | Recon: API-Schema der Zielplattform → `docs/api-notes.md` |
| 2 | `pax_client.py` — schlanker API-Client |
